<div class="row">
	...
	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
		...
		<div class="small-box bg-red" style="color: white!important;">
			<div class="inner">
				<h3>
					<?php echo !empty($total_centers) ? $total_centers : '0'; ?>
				</h3>
	...
	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
		...
		<div class="small-box bg-yellow">
			<div class="inner">
				<h3>
					<?php echo !empty($total_animators) ? $total_animators : '0'; ?>
				</h3>
	...
	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
		...
		<div class="small-box bg-blue">
			<div class="inner">
				<h3>
					<?php echo !empty($total_students) ? $total_students : '0'; ?>
				</h3>
	...
	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
		...
		<div class="small-box bg-maroon">
			<div class="inner">
				<h3>
					<?php echo !empty($total_cor_logedin) ? $total_cor_logedin : '0'; ?>
				</h3>
	...
	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
		...
		<div class="small-box bg-teal">
			<div class="inner">
				<h3>
					<?php echo !empty($total_ani_logedin) ? $total_ani_logedin : '0'; ?>
				</h3>
	...
	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
		...
		<div class="small-box bg-maroon" style="background-color: #ff2172 !important;">
			<div class="inner">
				<h3>
					<?php echo !empty($total_cor_absentee) ? $total_cor_absentee : '0'; ?>
				</h3>
	...
	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
		...
		<div class="small-box bg-teal" style="background-color: #45e7e7  !important;">
			<div class="inner">
				<h3>
					<?php echo !empty($total_ani_absentee) ? $total_ani_absentee : '0'; ?>
				</h3>
	...
	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
		...
		<div class="small-box bg-green">
			<div class="inner">
				<h3>
					<?php echo !empty($new_messages) ? $new_messages : '0'; ?>
				</h3>
